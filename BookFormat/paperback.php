<?php
 ...
 {  
    ...
    function insertdetails()
  {
   ...
   echo  
   $query  = "INSERT into paperback (author_name, book_size, book_cost,book_recorded_by, completion_time,illustrator_name,editor_name,book_main
  ...
  $p1= new paperback($_POST['b_weight'],$_POST['b_price'],$_POST['b_completion_time'],$_POST['author_name'],$_POST['publisher_name'],$_POST['editor_name'],$_POST['illustrator_name'], $_POST['book_main']);
