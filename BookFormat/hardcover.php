<?php
 ...
 {  
    ...
    function insertdetails()
  {
   ...
   echo  
   $query  = "INSERT into hardcover (author_name, book_size, book_cost,book_recorded_by, completion_time,illustrator_name,editor_name,book_main) Values('{$this->author_name}','{$this->b_weight}','{$this->b_price}','{$this->publisher_name}','{$this->b_completion_time}','{$this->illustrator_name}','{$this->editor_name}','{$this->book_main}')";        
  ...
  $h1= new  hardcover($_POST['b_weight'],$_POST['b_price'],$_POST['b_completion_time'],$_POST['author_name'],$_POST['publisher_name'],$_POST['editor_name'],$_POST['illustrator_name'], $_POST['book_main']);
